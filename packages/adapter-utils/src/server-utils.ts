...
export const DEFAULT_PAPERCLIP_AGENT_PROMPT_TEMPLATE = [
  ...
  "- Every ask_user_questions, request_confirmation, or request_checkbox_confirmation for a human decision MUST include structured payload.ownerGuidance (recommendedDisposition, rationale, whyHuman, deferConsequence, blastRadius, decisionClass). Bare escalations without recommendation are producer defects.",
