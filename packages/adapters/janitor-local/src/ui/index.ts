...
export const configSchema = {
  ...
  properties: {
    ...
    modules: {
      type: "array",
      items: { type: "string", enum: ["workspace", "storage", "security", "performance", "dev_tools", "review_knowledge"] },
      title: "Modules",
    ...
    approvalRequired: { type: "boolean", title: "Require approval for writes", default: true, description: "Must remain enabled for active mode" },
