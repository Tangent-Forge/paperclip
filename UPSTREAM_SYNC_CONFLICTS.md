# Upstream sync conflicts (2026-08-17)
...
```bash
git fetch upstream master && git checkout chore/upstream-sync-2026-08-17
git merge --no-ff upstream/master   # resolve, then commit
git push --force-with-lease origin chore/upstream-sync-2026-08-17
```

## Conflicting paths (68)
...
- `ui/src/components/artifacts/ArtifactCard.test.tsx`
- `ui/src/index.css`
- `ui/src/lib/inbox.ts`
