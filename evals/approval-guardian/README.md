...
The M6 24-105 shadow pilot fixture lives at `fixtures/m6-24-105-candidates.json`, with source excerpts under `fixtures/m6-24-105-sources/`. Run artifacts for the pilot are under `runs/m6-24-105-shadow/`, and the evidence-backed report is `reports/m6-24-105-shadow-pilot.md`. The M6 packets deliberately keep source recovery, parsed artifact, canonical DB ingest, and business/reconciliation conclusion as separate validation states.
